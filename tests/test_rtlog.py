...
def test_c3_rtlog_event_decode1():
    ...
    assert (
        C3DateTime(year=2017, month=7, day=31, hour=8, minute=54, second=10)
        == record.time_second
    )
...
def test_rtlog_unknown_verification_mode(_unused_update_inout_status_mock):
    with mock.patch("socket.socket") as mock_socket:
        ...
        mock_socket.return_value.recv.side_effect = [
            ...
            bytes.fromhex("d805fefea30955"),
            bytes.fromhex("aa00c80400"),
            bytes.fromhex("d805000062e955"),
        ]
...
def test_rtlog_keyvalue_response(_unused_update_inout_status_mock):
    with mock.patch("socket.socket") as mock_socket:
        ...
        mock_socket.return_value.send.return_value = 8
        mock_socket.return_value.recv.side_effect = [
            bytes.fromhex("aa02c90100"),
            bytes.fromhex("f357d955"),
            bytes.fromhex("aa02c80000"),
            bytes.fromhex("81fe55"),
            bytes.fromhex("aa02c84200"),
            bytes.fromhex(
                "7e53657269616c4e756d6265723d4143"
            ...
            bytes.fromhex("aa01c8c400"),
            bytes.fromhex(
                "74696d653d323032332d31322d30362032323a33333a3135097069"
            ...
            bytes.fromhex("aa01c83a00"),
            bytes.fromhex(
                "74696d653d323032332d31322d30392031353a30393a33330973656e736f72"
