...
def test_crc_real_log():
    ...
    # Request
    assert 0xcd2c == crc.crc16([0x01, 0xc8, 0x14, 0x00, 0x78, 0xe5, 0x02, 0x00, 0x03, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x00, 0x01, 0xff, 0x00, 0x00, 0x33, 0x75, 0x21])
    # Response
    assert 0x4f24 == crc.crc16(b'\x01\xc8\x14\x00\x54\xf1\x02\x00\x03\x00\x00\x00\x11\x00\x00\x00\x00\x01\xff\x00\xda\x3e\x75\x21')
